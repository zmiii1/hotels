            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add New Room Promo Code</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('promo.codes.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" name="discount_value" class="form-control @error('discount_value') is-invalid @enderror" value="{{ old('discount_value') }}" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" name="min_purchase" class="form-control @error('min_purchase') is-invalid @enderror" value="{{ old('min_purchase') }}" min="0">
                                    @error('min_purchase')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" name="max_discount" class="form-control @error('max_discount') is-invalid @enderror" value="{{ old('max_discount') }}" min="0">
                                    @error('max_discount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="max_uses" class="form-control @error('max_uses') is-invalid @enderror" value="{{ old('max_uses') }}" min="1">
                                    @error('max_uses')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <small class="text-muted d-block mb-2">Leave blank to apply to all rooms, or select multiple rooms to restrict this promo code to specific rooms only.</small>
                                    <select class="form-select select2 @error('room_ids') is-invalid @enderror" name="room_ids[]" multiple>
                                        @forelse($rooms as $room)
                                            <option value="{{ $room->id }}" {{ in_array($room->id, old('room_ids', [])) ? 'selected' : '' }}>
                                    ...
                                    @error('room_ids')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Hold Ctrl (or Cmd on Mac) to select multiple rooms</small>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-end">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save me-1"></i>Create Room Promo Code
                                    </button>
