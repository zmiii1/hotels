...
<!-- Hero Section -->
<section class="tl-hero-section tlresort">
    <div class="tl-hero-content">
        <h1>TANJUNG LESUNG<br>BEACH RESORT</h1>
...
<section id="about" class="tl-about-section">
    <div class="container">
        <h2 class="tl-section-title">Welcome to Tanjung Lesung Beach Resort</h2>
        <div class="tl-about-content">
            <div class="tl-about-text">
                <h3>Discover Comfort in Tropical Beach</h3>
                <p>Refresh your mind and body in Tanjung Lesung Beach Resort. With a location near the beach, you can enjoy a panoramic view of the Indian Ocean from a private balcony, take a leisure stroll along the white sandy beaches, see large green trees and a variety of plants that almost fill the area, birdsong that are lined up among the trees.</p>
                <p>Coupled with complete facilities and fun activities, Tanjung Lesung Beach Resort may get your holiday more enjoyable.</p>
            ...
            <div class="tl-about-image tlresort"></div>
        </div>
    </div>
</section>
...
<section class="tl-rooms-section">
    <div class="container">
        ...
        @php
            $hotel = App\Models\Hotel::where('slug', 'tlresort')->first();
        ...
        @foreach($roomTypes as $index => $roomType)
            <div class="tl-room-card {{ $index % 2 == 1 ? 'reverse' : '' }}">
                ...
                <div class="tl-room-info">
                    ...
                    <a href="{{ route('room.reservation', ['hotel' => 'tlresort']) }}" class="tl-view-more-btn">VIEW DETAILS</a>
                </div>
            </div>
        @endforeach
    </div>
